...
| **Cross-artifact**    | Mapping Document (typed `source`/`target` references, `targets` per mapping, relationship types) | [Mapping Document Guide](mapping/mapping-document-guide) |
