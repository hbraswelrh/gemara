...
For a system or component — identify capabilities and threats, map them to attack surfaces (Layer 2).

### Defining security controls

That mitigate those threats — create a control catalog with assessment requirements and threat-mappings (Layer 2).

### Understanding what threats and controls exist

Before writing policy — review or author threat-informed controls that your policy will reference (Layer 2). *(Coming soon)*
